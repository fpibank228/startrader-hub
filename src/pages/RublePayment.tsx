...
const RublePayment = () => {
  ...
  const checkPaymentStatus = () => {
    ...
    // Имитация проверки статуса оплаты
    setTimeout(() => {
      // В реальном приложении здесь будет запрос к API для проверки статуса платежа
      // const response = await apiService.checkPaymentStatus(paymentReference);
      
      // Временно: 50/50 шанс успеха (для демонстрации)
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium flex items-center gap-1">
                  {state?.stars || '0'}
                  <svg width="18" height="18" viewBox="0 0 14 15" fill="#fde047" xmlns="http://www.w3.org/2000/svg">
