...
const RublePayment = () => {
    ...
    useEffect(() => {
        ...
        setStarsToReceive(numericAmount / 100);
    }, [amount]);
    ...
    const handleSubmit = () => {
        ...
        setTimeout(() => {
            window.location.href = 'https://payment.wata.pro/pay-form/3a19746c-0f3a-7c9b-e9a3-197365300bf6';
        }, 1000);
    };
