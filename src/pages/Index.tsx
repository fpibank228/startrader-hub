      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        <div className="flex flex-col gap-8 max-w-lg mx-auto">
          ...
          >
            <StarCard glowEffect className="flex items-center p-6">
              <div className="mr-4">
                <div className="w-12 h-12 rounded-full bg-customMidBlue flex items-center justify-center">
                  <Star className="w-6 h-6 text-white" fill="white" />
                </div>
              </div>
              <div>
                <h3 className="text-xl font-bold mb-1">Продавайте звезды</h3>
                <p className="text-white/70 text-sm">
                  Продавайте ненужные звезды Telegram за $0.007 за звезду
                </p>
              </div>
            </StarCard>
          </motion.div>
