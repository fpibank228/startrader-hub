...
import BigRouletteWheel from "@/components/roulette/BigRouletteWheel.tsx";
...
const BigBasicRoulette = () => {
    ...
    const fetchData = async () => {
        try {
            const itms = await apiService.createBigDefaultGiftSpinInvoice();
...
export default BigBasicRoulette;
