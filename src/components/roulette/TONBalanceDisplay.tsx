        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-lg font-semibold flex items-center gap-1">
              {balance.toFixed(1)}
                <svg width="20" height="20" viewBox="0 0 14 15" fill="#546CF3" xmlns="http://www.w3.org/2000/svg">
          ...
          <div
              className="flex items-center gap-2 bg-gradient-to-r from-blue-500/20 to-purple-500/20 px-3 py-1.5 rounded-lg border border-white/10">
              <span className="text-white text-sm font-medium">STARS.BET</span>
          </div>
      </div>
    </motion.div>
  );
