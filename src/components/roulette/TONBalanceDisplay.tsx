        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="flex items-center gap-1">
              <span className="text-lg font-semibold">{balance.toFixed(1)}</span>
              <svg width="20" height="20" viewBox="0 0 14 15" fill="#546CF3" xmlns="http://www.w3.org/2000/svg" className="mt-0.5">
