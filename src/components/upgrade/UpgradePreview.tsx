            ...
            <>
              ...
              <div className="flex flex-col items-center mb-4">
                ...
                <div className="text-center">
                  ...
                  <div className="w-32 h-32 mx-auto bg-white/10 rounded-lg p-2 border border-white/20">
                    <LottieItem
            ...
            <div className="flex flex-col items-center pt-2 pb-4">
              ...
              {isSuccess ? (
                <div className="text-center mb-6">
                  ...
                  <div className="w-40 h-40 mx-auto bg-white/10 rounded-lg p-2 border border-white/20 mb-4">
                    <LottieItem
                      animationData={potentialReward.link}
                      className="w-full h-full"
                    />
                ...
                <div className="text-center mb-6">
                  ...
                  <p className="text-white/70 mb-4">
                    К сожалению, апгрейд не удался. Попробуйте еще раз с другими подарками или множителем.
                  </p>
                </div>
              )}
